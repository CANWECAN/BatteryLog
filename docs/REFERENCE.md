# BatteryLog technical reference

Detailed input, configuration, schema, CLI, API, event, and engineering semantics moved out of the main README for readability.
